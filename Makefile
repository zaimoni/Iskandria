...
Iskandria.exe : make_Zaimoni_STL $(OBJECTS_ISKANDRIA_LINK_PRIORITY)
	g++ $(LINK_FLAGS) -oIskandria.exe $(OBJECTS_ISKANDRIA) -lz_log_adapter -lz_logging -lz_format_util -lz_stdio_c -lz_stdio_log -lz_clock  -lsfml-graphics -lsfml-window -lsfml-system -lwinmm
