...
bool product::self_eval() {
	...
	if (this->_self_eval(_n_ary_op::is_multiplicative_identity, zaimoni::math::rearrange_product, zaimoni::math::product_score, zaimoni::math::product_score, zaimoni::math::eval_product)) return true;
